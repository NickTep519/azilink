                ...
                <div class="container">
                    ...
                    <div class="section-box box-statistical">
                        <div class="row">
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="<?php echo e(asset('dash/assets/imgs/template/icons/hotel2.svg')); ?>"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span
                                                    class="count"><?php echo e($trajets_en_cours->count()); ?></span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="<?php echo e(asset('dash/assets/imgs/template/icons/user.svg')); ?>"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span class="count">
                                                    <?php echo e($trajets_termine->count()); ?> </span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="<?php echo e(asset('dash/assets/imgs/template/icons/book.svg')); ?>"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span class="count">
                                                    <?php echo e($trajets_termine->count() + $trajets_en_cours->count()); ?> </span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="<?php echo e(asset('dash/assets/imgs/template/icons/earn.svg')); ?>"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span class="count">
                                                    <?php echo e($gain_en_cours->count()); ?> </span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    ...
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span class="count">
                                                    <?php echo e($gain_termine->count()); ?> </span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    ...
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span
                                                    class="count"><?php echo e($gain_en_cours->count() + $gain_termine->count()); ?></span>
                                            </h3>
                                        </div>
                        ...
                        <table class="table table-stripped table-mybooking">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $trajets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trajet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td alt="titre"> <span class="text-md-medium neutral-500">
                                                <?php echo e($trajet->type == 1 ? 'Offre' : 'Demande'); ?> </span>
                                            <?php if($trajet->status === 'archive'): ?>
                                                🗃️
                                            <?php endif; ?>
                                        </td>
                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($trajet->starts_city); ?> </span>
                                        </td>
                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($trajet->ends_city); ?> </span>
                                        </td>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end">
                                                    <?php if($trajet->type == 1): ?>
                                                        <li><a class="dropdown-item"
                                                                href="<?php echo e(route('offers.show', [$trajet->slug(), $trajet])); ?>">Voir</a>
                                                        </li>
                                                    <?php else: ?>
                                                        <li><a class="dropdown-item"
                                                                href="<?php echo e(route('requests.show', [$trajet->slug(), $trajet])); ?>">Voir</a>
                                                        </li>
                                                    <?php endif; ?>


                                                    <li><a class="dropdown-item"
                                                            href="<?php echo e(route('annonces.edit', $trajet)); ?>">Editer</a></li>
                                                    <?php if($trajet->status != 'archive'): ?>
                                                        <li>
                                                            <form action="<?php echo e(route('annonces.archive', $trajet)); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                    ...
                                                    <li>
                                                        <form action="<?php echo e(route('annonces.destroy', $trajet)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                    ...
                    <?php if(!$trajets->isEmpty() && $trajets->count() >= 30): ?>
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="<?php echo e($trajets->previousPageUrl()); ?>"
                                ...
                                <?php for($i = 1; $i <= $trajets->lastPage(); $i++): ?>
                                    ...
                                    <?php else: ?>
                                        <li class="page-item"><a class="page-link"
                                                href="<?php echo e($trajets->url($i)); ?>"><?php echo e($i); ?></a></li>
                                    <?php endif; ?>
                                <?php endfor; ?>

                                <li class="page-item"><a class="page-link" href="<?php echo e($trajets->nextPageUrl()); ?>"
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217000542/domains/atlasinvest-limited.com/public_html/azilink/resources/views/annonces/trajets.blade.php ENDPATH**/ ?>