...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/css/date-picker.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/css/magnific-popup.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/css/style.css')); ?>" media="screen" id="color">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/css/themify-icons.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/css/tour.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/js/ckeditor/skins/moono-lisa/editor.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/js/ckeditor/plugins/scayt/skins/moono-lisa/scayt.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/js/ckeditor/plugins/scayt/dialogs/dialog.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/js/ckeditor/plugins/tableselection/styles/tableselection.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/js/ckeditor/plugins/wsc/skins/moono-lisa/wsc.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('../asset/js/ckeditor/plugins/copyformatting/styles/copyformatting.css')); ?>">
...
<body class="sidebar-active">
        ...
        <nav class="main-nav on custom-scroll">
            ...
            <div class="sidebar-main">
                ...
                <ul class="sidebar-bottom">
                    ...
                    <li><a class="icon-btn btn-light" href="<?php echo e(route('login')); ?>" data-tippy-content=" SignOut"> <i
                                            ...
                                            <ul class="chat-main">
                                                ...
                                                <li data-to="blank">
                                                    ...
                                                    <div class="chat-box">
                                                        ...
                                                        <div class="details">
                                                            <h5 data-conversation-id="<?php echo e($conversation->id); ?>" > <?php echo e($conversation->users->where('id', '!=', auth()->user()->id)->first()->name); ?>  | <?php echo e(Str::limit($conversation->title, 15)); ?> </h5>

                                                            <h6> <?php echo e($conversation->lastMessage?->content ?? ''); ?> </h6>
                                                        </div>
                                                        <div class="date-status"><i class="ti-pin2"></i>
                                                            <h6> <?php echo e($conversation->lastMessage?->created_at?->diffForHumans() ?? ''); ?> </h6>
    ...
    <script src="<?php echo e(asset('../asset/js/tippy-bundle.iife.min.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/bootstrap.bundle.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/switchery.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/easytimer.min.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/index.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/feather-icon/feather.min.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/feather-icon/feather-icon.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/ckeditor/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/ckeditor/styles.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/ckeditor/adapters/jquery.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/ckeditor/ckeditor.custom.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/date-picker/datepicker.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/date-picker/datepicker.en.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/date-picker/datepicker.custom.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/tour/intro.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/tour/intro-init.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/jquery.magnific-popup.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/zoom-gallery.js')); ?>"></script>
    <script src="<?php echo e(asset('../asset/js/script.js')); ?>"></script>

    <script>
        window.User = {
            id : <?php echo e(optional(auth()->user())->id); ?> 
        }
    </script>
    <script src="<?php echo e(asset('../asset/js/chat.js')); ?>" ></script>
</body>

</html>
<?php /**PATH D:\projets\taffe\azilink\resources\views\conversations\bababab.blade.php ENDPATH**/ ?>