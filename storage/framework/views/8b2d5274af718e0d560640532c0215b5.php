...
<?php endif; ?>
                    ...
                    <div class="flex items-center justify-end mt-4 btn btn-black"> 
                        <button style="all: unset" type="submit"> <?php echo e(__('Lien de réinitialisation du mot de passe par e-mail')); ?>  </button> 
                    </div>
                </form>
            </div>
          </div>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217000542/domains/atlasinvest-limited.com/public_html/azilink/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>