<?php $__env->startSection('title', config('app.name') . ' | ' . 'offres'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <main class="main">
        ...
        <section class="box-section block-banner-tickets">
            <div class="container">
                <div class="text-center">
                    ...
                    <h6 class="heading-6-medium">Explorer les offres disponibles.</h6>
                </div>
                    ...
                    <form action="">
                        <div class="box-bottom-search background-card">
                            <div class="item-search item-search-2">
                                <label for="starts_city" class="text-sm-bold neutral-500">Ville Depart</label>
                                <div>
                                    <input name="starts_city" id="starts_city" value="<?php echo e(request()->input('starts_city')); ?>"
                                        class="search-input cityInput" type="text" placeholder="">
                                    <ul id="suggestions"
                                        style="list-style: none; padding: 0; margin-top: 5px;  color :#fff; background-color: #303c44 ; border: 1px solid #303c44; max-width: 300px;">
                                    </ul>
                                </div>
                            </div>
                            <div class="item-search item-sea rch-3">
                                <label for="ends_city" class="text-sm-bold neutral-500">Ville Arrivée</label>
                                <div>
                                    <input id="ends_city" name="ends_city" value="<?php echo e(request()->input('ends_city')); ?>"
                                        class="search-input cityInput" type="text" placeholder="">
                                    <ul id="suggestions"
                                        style="list-style: none; padding: 0; margin-top: 5px;  color :#fff; background-color: #303c44 ; border: 1px solid #303c44; max-width: 300px;">
                                    </ul>
                            ...
                            <div class="item-search item-search-2">
                                <label for="kg" class="text-sm-bold neutral-500">Poids (Kg) </label>
                                <div>
                                    <input type="number" min="0" id="kg" name="kg" class="search-input"
                                        value="<?php echo e(request()->input('kg')); ?>" placeholder="">
                                    <ul id="suggestions"
                                        style="list-style: none; padding: 0; margin-top: 5px;  color :#fff; background-color: #303c44 ; border: 1px solid #303c44; max-width: 300px;">
                                    </ul>
                                </div>
                            ...
                            <div class="item-search item-search-2">
                                <label for="price" class="text-sm-bold neutral-500 mb-4">Prix/kg</label>
                                <div id="slider-range"></div>
                                <div class="box-value-price"><span class="text-md-medium neutral-1000">0€</span><span
                                        class="text-md-medium neutral-1000">100€</span></div>
                                <input id="price" class="value-money" value="<?php echo e(request()->input('price')); ?>"
        ...
        <section id="filtered-results" class="box-section block-content-tourlist background-body">
            <div class="container">
                <div class="box-content-main pt-20 pb-0">
                                    ...
                                    <div class="box-view-type"><a class="display-type display-grid active"
                                            ...
                                            <svg width="21" height="21" viewbox="0 0 21 21" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    fill=""></path>
                                            </svg></a><span class="text-sm-bold neutral-500 number-found">Plus de
                                            <?php echo e($toutes_les_offres); ?> offre(s) disponibles </span></div>
                                </div>
                            </div>
                        </div>
                        <div class="box-list-tickets wow fadeIn">
                            <div class="row">
                                            ...
                                            <div class="card-image"> <a class="wish" href="#">
                                                    <svg width="20" height="18" viewbox="0 0 20 18"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"></path>
                                                    </svg></a><img src="<?php echo e($offer->image_city_destination); ?>"
                                                    alt="Azilink"></div>
                                            <div class="card-info">
                                                <div class="card-date"><span class="date-1">
                                                        <?php echo e($offer->starts_at->translatedFormat('d M Y')); ?> </span><span
                                                        class="line"></span><span
                                                        class="date-1"><?php echo e($offer->ends_at->translatedFormat('d M Y')); ?></span>
                                                </div>
                                                <div class="card-route">
                                                    <h8 class="route-name neutral-1000"> <?php echo e($offer->starts_city); ?> </h8>
                                                    <span class="icon-route"></span>
                                                    <h8 class="route-name neutral-1000"> <?php echo e($offer->ends_city); ?> </h8>
                                                </div>
                                                <div class="card-price">
                                                    <div class="card-price-1">
                                                        <p class="text-md-medium">Poids Disponible</p>
                                                        <h6 class="neutral-1000"> <?php echo e($offer->kg_restant); ?> Kg
                                                        </h6>
                                                    </div>
                                                    <div class="card-price-1">
                                                ...
                                                <div class="card-meta">
                                                    <div class="card-seats" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                                                        ...
                                                        <div class="card-button">
                                                            <a class="btn btn-gray" href="<?php echo e(route('offers.show', [$offer->slug(), $offer])); ?>">Voir..</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    ...
                                    <p> Aucune offre trouvée. <a
                                            href="<?php echo e(route('annonces.create', array_merge(request()->all(), ['type' => 1]))); ?>">
                                            Laissez une demande.</a> </p>
                                <?php endif; ?>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link" href="<?php echo e($offers->previousPageUrl()); ?>"
                                    ...
                                    <?php for($i = 1; $i <= $offers->lastPage(); $i++): ?>
                                        <?php if($offers->currentPage() === $i): ?>
                                            <li class="page-item"><a class="page-link active"><?php echo e($i); ?></a>
                                            </li>
                                        <?php else: ?>
                                            <li class="page-item"><a class="page-link"
                                                    href="<?php echo e($offers->url($i)); ?>"><?php echo e($i); ?></a></li>
                                        <?php endif; ?>
                                    <?php endfor; ?>

                                    <li class="page-item"><a class="page-link" href="<?php echo e($offers->nextPageUrl()); ?>"
        ...
        <section class="section-box box-media background-body">
            <div class="container-media wow fadeInUp"> <img src="assets/imgs/page/homepage5/media.png"
                    alt="Azilink"><img src="assets/imgs/page/homepage5/media2.png" alt="Azilink"><img
                    src="assets/imgs/page/homepage5/media3.png" alt="Azilink"><img
                    src="assets/imgs/page/homepage5/media4.png" alt="Azilink"><img
                    src="assets/imgs/page/homepage5/media5.png" alt="Azilink"><img
                    src="assets/imgs/page/homepage5/media6.png" alt="Azilink"><img
                    src="assets/imgs/page/homepage5/media7.png" alt="Azilink"></div>
        </section>
    </main>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217000542/domains/atlasinvest-limited.com/public_html/azilink/resources/views/annonces/offers/index.blade.php ENDPATH**/ ?>