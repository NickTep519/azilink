...
<main class="main">
    <section class="box-section block-banner-home10"> 
      <div class="container"> 
        <p class="text-with-img mb-30"> <img src="<?php echo e(asset('assets/imgs/page/homepage10/earth.png')); ?>" alt="<?php echo e(config('app.name')); ?>">Le meilleur système d'echange international</p>
        ...
        <div class="box-buttons-banner mt-65">
            <?php if(auth()->guard()->check()): ?>
             <a class="btn btn-brand-secondary" href="<?php echo e(route('offers.index')); ?>"> Commencer
            ...
            <?php if(auth()->guard()->guest()): ?>
             <a class="btn btn-brand-secondary" href="<?php echo e(route('register')); ?>"> Commencer
            <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 19L19 12L12 5M19 12L5 12" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg></a>
            <?php endif; ?>
            
            <a class="btn btn-how-work color-white" href="<?php echo e(route('offers.index')); ?>"><img src="assets/imgs/page/homepage10/play.png" alt="AziLink">Voir les Trajets
            </a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
                  ...
                  <div class="col-lg-6"> 
                      <div class="card-flight background-card"> 
                        <div class="card-image"> <a class="wish" href="#">
                            ...
                            </svg></a><img src="<?php echo e($offer->image_city_destination); ?>" alt="AziLink"></div>
                        <div class="card-info"> 
                          <div class="card-date"><span class="date-1"> <?php echo e($offer->starts_at->translatedFormat('d M Y')); ?> </span><span class="line"></span><span class="date-1"><?php echo e($offer->ends_at->translatedFormat('d M Y')); ?></span></div>
                          <div class="card-route"> 
                            <h8 class="route-name neutral-1000"> <?php echo e($offer->starts_city); ?> </h8><span class="icon-route"></span>
                            <h8 class="route-name neutral-1000"> <?php echo e($offer->ends_city); ?> </h8>
                          </div>
                          <div class="card-price"> 
                            <div class="card-price-1"> 
                              <p class="text-md-medium">Poid demandé</p>
                              <h6 class="neutral-1000"> <?php echo e($offer->kg); ?> Kg </h6>
                            </div>
                            <div class="card-price-1"> 
                              <p class="text-md-medium"> Prix/Kg </p>
                              <h6 class="neutral-1000"><?php echo e($offer->price); ?> €</h6>
                            </div>
                          </div>
                          <div class="card-meta"> 
                            ...
                            <div class="card-seats"> 
                              <div class="card-button"> <a class="btn btn-gray" href="<?php echo e(route('offers.show', [$offer->slug(), $offer])); ?>">Voir..</a></div>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="row align-items-end">
              ...
              <div class="col-md-3 position-relative mb-30 wow fadeInUp">
                <div class="d-flex justify-content-center justify-content-md-end"><a class="btn btn-black-lg" href="<?php echo e(route('offers.index')); ?>">Voir Plus 
    ...
    <section class="section-box box-best-sell background-body">
      <div class="container"> 
                ...
                <div class="box-list-flights box-list-flights-2"> 
                  ...
                  <div class="item-flight background-card border-1">
                    <div class="flight-route"> 
                      <div class="flight-name"><img src="<?php echo e(asset('assets/imgs/page/tickets/logo' . rand(2, 6) . '.png')); ?>" alt="AziLink">
                        <div class="flight-info"> 
                          <p class="text-md-bold neutral-1000"><?php echo e($request->starts_city); ?></p>
                          <p class="text-sm-medium time-flight"> <span class="neutral-1000"></span><?php echo e($request->starts_at->translatedFormat('d M Y')); ?></p>
                        </div>
                      </div>
                      <div class="flight-route-icon"></div>
                      <div class="flight-name"> 
                        <div class="flight-info"> 
                          <p class="text-md-bold neutral-1000"><?php echo e($request->ends_city); ?></p>
                          <p class="text-sm-medium time-flight"><span class="neutral-1000"></span><?php echo e($request->ends_at->translatedFormat('d M Y')); ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="flight-price">
                      <div class="flight-price-1 border-1"> 
                        ...
                        <p class="text-lg-bold neutral-1000"><?php echo e($request->kg); ?> Kg</p>
                      </div>
                    ...
                    <div class="box-author-small">
                      ...
                      <p class="text-sm-bold neutral-1000"> 
                        <a href="<?php echo e(route('users.details', $request->creatorUser->slug )); ?>" style="color: black; text-decoration: none;" class="text-sm-bold">
                    ...
                    <div class="flight-button"> 
                      <a class="btn btn-gray" href="<?php echo e(route('requests.show', [$request->slug(), $request])); ?>">Voir..</a>
                    </div>
                  </div>
        ...
        <div class="row align-items-end">
          ...
          <div class="col-md-3 position-relative mb-30 wow fadeInUp">
            <div class="d-flex justify-content-center justify-content-md-end"><a class="btn btn-black-lg" href="<?php echo e(route('requests.index')); ?>">Voir Plus 
                <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 15L15 8L8 1M15 8L1 8" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg></a></div>
          </div>
      ...
      <div class="container"> 
        ...
        <div class="box-list-populars"> 
          <div class="row"> 
           ...
           <?php $__currentLoopData = $popularCitiesAnnonces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           
           <div class="col-lg-3 col-sm-6"> 
              <div class="card-popular background-card hover-up"> 
                <div class="card-image"> <a href="#"><img width="110" height="110" src="<?php echo e($annonce->image_city_destination); ?>" alt="AziLink"></a></div>
                <div class="card-info"> <a class="card-title" href="<?php echo e(route('offers.index', ['ends_city' => $annonce->city_destination] )); ?>"><?php echo e($annonce->ends_city); ?></a>
                  <div class="card-meta"> 
                    <div class="meta-links"> <a href="#"> plus de <?php echo e($annonce->ads_count); ?> annonces</a><a href="#"></a></div>
    ...
    <section class="section-box box-how-it-work-3 background-body">
      <div class="container"> 
        <div class="box-how-it-work-inner background-3">
          ...
          <p class="text-xl-medium neutral-500 mb-30 wow fadeInUp">Juste 4 avantages d'<?php echo e(config('app.name')); ?></p>
          <div class="row">
            <div class="col-lg-10">
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217000542/domains/atlasinvest-limited.com/public_html/azilink/resources/views/home.blade.php ENDPATH**/ ?>