<?php $__env->startSection('meta'); ?>
    ...
    <meta property="og:title" content="<?php echo e($request->title); ?>" />
    <meta property="og:description" content="<?php echo e($request->description); ?>" />
    <meta property="og:url" content="<?php echo e(url()->current()); ?>" />
    <meta property="og:image" content="<?php echo e($request->image_city_destination); ?>" />
    <meta property="og:type" content="<?php echo e('website'); ?>" />
    <meta property="og:site_name" content="<?php echo e(config('app.name')); ?>" />



    <meta name="twitter:card" content="<?php echo e($request->image_city_destination); ?>">
    <meta name="twitter:title" content="<?php echo e($request->title); ?>">
    <meta name="twitter:description" content="<?php echo e($request->description); ?>">
    <meta name="twitter:image" content="<?php echo e($request->image_city_destination); ?>">
...
<?php $__env->startSection('title', config('app.name') . ' | requests | ' . $request->title); ?>
        ...
        <section class="box-section box-breadcrumb background-body">
            <div class="container text-center">
                <ul class="breadcrumbs">
                    <li> <a href="<?php echo e(route('home')); ?>">Accueille</a><span class="arrow-right">
                            <svg width="7" height="12" viewbox="0 0 7 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 11L6 6L1 1" stroke="" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                            </svg></span></li>
                    <li> <a href="<?php echo e(route('requests.index')); ?>">requests</a><span class="arrow-right">
                            <svg width="7" height="12" viewbox="0 0 7 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 11L6 6L1 1" stroke="" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                            </svg></span></li>
                    <li> <span class="text-breadcrumb"> <?php echo e($request->title); ?> </span></li>
                </ul>
            </div>
        </section>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="box-banner-tour-4">
                                        <img src="<?php echo e($request->image_city_destination); ?>" alt="Travila">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="tour-header tour-header-on-top">
                        <div class="box-author-small">
                            <img src="<?php echo e(asset('storage/'.$request->creatorUser->image)); ?>" alt="Travilla" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
                            <p class="text-sm-bold" style="color: white" > 
                                <a href="<?php echo e(route('users.details', $request->creatorUser->slug )); ?>" style="color: white; text-decoration: none;" class="text-sm-bold">
                                    <?php echo e($request->creatorUser->pseudo); ?> <?php echo e($request->creatorUser->profileBadge()); ?>

                                </a>
                            </p>
                        </div>
                        <div class="tour-rate">
                            <div class="rate-element"><span class="rating">  <?php echo e($request->creatorUser->moyenne()); ?>  <span
                                        class="text-sm-medium neutral-500">( <?php echo e($request->views); ?> vues)</span></span></div>
                        </div>
                        <div class="tour-title-main w-lg-75">
                            <h4 class="color-white"> <?php echo e($request->title); ?> </h4>
                        </div>
                        <div class="tour-metas">
                            ...
                            <div class="tour-meta-right share-container"> <a class="btn btn-share">
                                ...
                                <div class="share-options">
                                    <!-- Liens de partage -->
                                    <a href="https://twitter.com/intent/tweet?text=<?php echo e($request->title); ?>.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!&url=<?php echo e(urlencode(route('requests.show', [$request->slug(), $request]))); ?>"
                                        target="_blank">Partager sur Twitter</a>
                                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(route('requests.show', [$request->slug(), $request]))); ?>"
                                        target="_blank">Partager sur Facebook</a>
                                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(urlencode(route('requests.show', [$request->slug(), $request]))); ?>&title=Super%20contenu&summary=Ceci%20est%20un%20résumé"
                                        target="_blank">Partager sur LinkedIn</a>
                                    <a href="https://wa.me/?text=<?php echo e($request->title); ?>.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!%20%20%20<?php echo e(urlencode(route('requests.show', [$request->slug(), $request]))); ?>"
                                        target="_blank">Partager sur WhatsApp</a>
                                    <a href="https://t.me/share/url?url=<?php echo e(urlencode(route('requests.show', [$request->slug(), $request]))); ?>&text=<?php echo e($request->title); ?>.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!"
                                        target="_blank">Partager sur Telegram</a>
                                    <a href="mailto:?subject=<?php echo e($request->title); ?>.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!<?php echo e(urlencode(route('requests.show', [$request->slug(), $request]))); ?>"
        ...
        <section class="box-section box-content-tour-detail background-body">
            <div class="container">
                <div class="row">
                        ...
                        <div class="box-info-tour">
                            ...
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->starts_city); ?> </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                <div class="icon-item">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->starts_at->translatedFormat('d M Y')); ?> </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->ends_city); ?> </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->ends_at->translatedFormat('d M Y')); ?> </p>
                                </div>
                            </div>
                        </div>
                        <div class="box-info-tour">
                            ...
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->kg_restant); ?> Kg </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                <div class="icon-item">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->price == NULL ? 'XX' : $request->price); ?> €</p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                <div class="icon-item background-7">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->company); ?> </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                <div class="icon-item background-3">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> <?php echo e($request->m_transport); ?> </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if(auth()->check()): ?>
                        <?php if(auth()->user()->id === $request->creatorUser->id): ?>
                        <?php else: ?>
                            <div class="col-lg-4">
                                    ...
                                    <div class="content-booking-form">
                                        <form action="<?php echo e(route('conversations.store')); ?>" method="POST">
                                            ...
                                            <input type="hidden" name="user_ids[]"
                                                value="<?php echo e($request->creatorUser->id); ?>">
                                            <input type="hidden" name="user_ids[]" value="<?php echo e(auth()->user()->id); ?>">
                                            <input type="hidden" name="annonce_id" value="<?php echo e($request->id); ?>">
                    ...
                    <?php else: ?>
                        <div class="col-lg-4">
                            <div class="booking-form">
                                ...
                                <div class="content-booking-form">
                                    <div class="box-button-book">
                                        <a class="btn btn-book btn-signin" href="<?php echo e(route('login')); ?>">Se Connecter
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217000542/domains/atlasinvest-limited.com/public_html/azilink/resources/views/annonces/requests/show.blade.php ENDPATH**/ ?>