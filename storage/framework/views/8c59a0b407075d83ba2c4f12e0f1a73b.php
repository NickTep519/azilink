...
<html lang="en">
    ...
    <head>
        ...
        <!-- Template CSS -->
        <link class="css-lt" rel="stylesheet" href="messenger_assets/css/template.bundle.css" media="(prefers-color-scheme: light)">
        <link class="css-dk" rel="stylesheet" href="messenger_assets/css/template.dark.bundle.css" media="(prefers-color-scheme: dark)">
            ...
            <nav class="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
                ...
                <ul class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3" role="tablist">
                    ...
                    <li class="nav-item d-none d-xl-block invisible flex-xl-grow-1">
                        <a class="nav-link py-0 py-lg-8" href="index.html#" title="">
                    ...
                    <!-- New chat -->
                    <li class="nav-item">
                        <a class="nav-link py-0 py-lg-8" id="tab-create-chat" href="index.html#tab-content-create-chat" title="Create chat" data-bs-toggle="tab" role="tab">
                            <div class="icon icon-xl">
                    ...
                    <!-- Friends -->
                    <li class="nav-item">
                        <a class="nav-link py-0 py-lg-8" id="tab-friends" href="index.html#tab-content-friends" title="Friends" data-bs-toggle="tab" role="tab">
                            <div class="icon icon-xl">
                    ...
                    <!-- Chats -->
                    <li class="nav-item">
                        <a class="nav-link active py-0 py-lg-8" id="tab-chats" href="index.html#tab-content-chats" title="Chats" data-bs-toggle="tab" role="tab">
                    ...
                    <!-- Notification -->
                    <li class="nav-item">
                        <a class="nav-link py-0 py-lg-8" id="tab-notifications" href="index.html#tab-content-notifications" title="Notifications" data-bs-toggle="tab" role="tab">
                            <div class="icon icon-xl">
                    ...
                    <li class="nav-item d-none d-xl-block flex-xl-grow-1">
                        <a class="nav-link py-0 py-lg-8" id="tab-support" href="index.html#tab-content-support" title="Support" data-bs-toggle="tab" role="tab">
                            <div class="icon icon-xl">
                    ...
                    <li class="nav-item d-none d-xl-block">
                        <a class="switcher-btn nav-link py-0 py-lg-8" href="index.html#!" title="Themes">
                    ...
                    <!-- Settings -->
                    <li class="nav-item">
                        <a class="nav-link py-0 py-lg-8" id="tab-settings" href="index.html#tab-content-settings" title="Settings" data-bs-toggle="tab" role="tab">
                            <div class="icon icon-xl">
                                ...
                                <div class="container py-8">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <ul class="nav nav-pills nav-justified" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="pill" href="index.html#create-chat-info" role="tab" aria-controls="create-chat-info" aria-selected="true">
                                                    Details
                                                </a>
                                            </li>

                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="pill" href="index.html#create-chat-members" role="tab" aria-controls="create-chat-members" aria-selected="true">
                                                    People
                                                </a>
                                            </li>
                                        </ul>
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="messenger_assets/img/avatars/6.jpg" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="messenger_assets/img/avatars/5.jpg" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar avatar-online">
                                                                        ...
                                                                        <img class="avatar-img" src="messenger_assets/img/avatars/8.jpg" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="messenger_assets/img/avatars/11.jpg" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar ">
                                                                        ...
                                                                        <img class="avatar-img" src="messenger_assets/img/avatars/4.jpg" alt="">
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <div class="avatar avatar-online">
                                                                        ...
                                                                        <img class="avatar-img" src="messenger_assets/img/avatars/7.jpg" alt="">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-center gx-5">
                                                    ...
                                                    <div class="col-auto">
                                                        <!-- Dropdown -->
                                                        <div class="dropdown">
                                                            <a class="icon text-muted" href="index.html#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg>
                                                            </a>

                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="index.html#">New message</a></li>
                                                                <li><a class="dropdown-item" href="index.html#">Edit contact</a>
                                                                </li>
                                                                <li>
                                                                    <hr class="dropdown-divider">
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item text-danger" href="index.html#">Block user</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                            ...
                            <div class="hide-scrollbar">
                                ...
                                <div class="container py-8">
                                    ...
                                    <div class="card-list">
                                        ...
                                        <a href="chat-group.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="messenger_assets/img/avatars/7.jpg" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row align-items-center gx-4">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-xs">
                                                            <img class="avatar-img" src="messenger_assets/img/avatars/bootstrap.svg" alt="Bootstrap Community">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="avatar-group">
                                                            <div class="avatar avatar-xs">
                                                                <img src="messenger_assets/img/avatars/12.jpg" alt="#" class="avatar-img">
                                                            </div>

                                                            <div class="avatar avatar-xs">
                                                                <img src="messenger_assets/img/avatars/11.jpg" alt="#" class="avatar-img">
                                                            </div>

                                                            <div class="avatar avatar-xs">
                                                                <img src="messenger_assets/img/avatars/9.jpg" alt="#" class="avatar-img">
                                                            </div>
                                        ...
                                        <a href="chat-direct.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="messenger_assets/img/avatars/6.jpg" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                        ...
                                        <a href="chat-empty.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="messenger_assets/img/avatars/8.jpg" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                        ...
                                        <a href="chat-direct.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar">
                                                            <img src="messenger_assets/img/avatars/4.jpg" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                        ...
                                        <a href="chat-direct.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="messenger_assets/img/avatars/5.jpg" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
                                        ...
                                        <!-- Card -->
                                        <a href="index.html#" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="dropdown ms-5">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="index.html#">Show less often</a></li>
                                                                    <li><a class="dropdown-item" href="index.html#">Hide</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card border-0">
                                            <div class="card-body">
                                                ...
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <!-- Avatar -->
                                                        <a href="index.html#tab-settings" class="avatar avatar-badged" data-theme-toggle="tab">
                                                    ...
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mb-2">
                                                            <h5 class="me-auto mb-0">
                                                                <a href="index.html#tab-settings" data-theme-toggle="tab">
                                                                    Notifications
                                                                </a>
                                                            </h5>
                                                            <span class="extra-small text-muted ms-2">08:45 PM</span>
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center gx-5">
                                                <div class="col-auto">
                                                    <div class="avatar">
                                                        <img src="messenger_assets/img/avatars/1.jpg" alt="#" class="avatar-img">
                                                    ...
                                                    <div class="accordion-item">
                                                        <div class="accordion-header">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-auto">
                                                                    <a class="switcher-btn text-reset" href="index.html#!" title="Themes">
                ...
                <div class="modal-content">
                        ...
                        <div>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center text-danger" href="index.html#">
                    ...
                    <div  class="modal-body p-0">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <img class="img-fluid modal-preview-url" src="index.html#" alt="#">
                        </div>
                    </div>
                    <!-- Modal: Body -->
...
</html><?php /**PATH D:\projets\taffe\azilink\resources\views\messenger\test.blade.php ENDPATH**/ ?>