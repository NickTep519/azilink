<?php $__env->startSection('title', config('app.name'). ' | ' . $user->pseudo); ?>
...
<section class="box-section box-breadcrumb background-body">
    <div class="container"> 
      <ul class="breadcrumbs"> 
        <li> <a href="<?php echo e(route('home')); ?>">Home</a><span class="arrow-right"> 
            <svg width="7" height="12" viewbox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 11L6 6L1 1" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg></span></li>
        <li> <a href="<?php echo e(route('home')); ?>">Users</a><span class="arrow-right"> 
            <svg width="7" height="12" viewbox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 11L6 6L1 1" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg></span></li>
        <li> <span class="text-breadcrumb"><?php echo e($user->pseudo); ?> <?php echo e($user->profileBadge()); ?> </span></li>
      </ul>
    </div>
  </section>
  ...
  <section class="section-box block-banner-book-tickets background-card">
    <div class="container">
      <div class="box-image-book">
        ...
        <img src="<?php echo e(asset('assets/imgs/page/tickets/banner-booking.png')); ?>" alt="Travila" class="banner-cover">
        
        <!-- Image de profil circulaire -->
        <a class="btnn-logo" href="#">
          <img src="<?php echo e(asset('storage/'.$user->image)); ?>" alt="Travila" class="circular-banner">
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="section-box block-content-book-tickets background-card">
    <div class="container"> 
        <h4 class="neutral-1000 mb-20"> <?php echo e($user->profileLevel()); ?> </h4>
          ...
          <div class="box-content-tickets-detail"> 
            <div class="box-timeline"> 
              <div class="item-timeline"> <span class="text-xl-bold text-ads-middle">  </span>
                ...
                <?php if($user->lastAnnonce()): ?>

                <div class="item-line-timeline">

                    <div class="time-flight">
                      <p class="text-xl-bold neutral-1000">Dernier trajet : <?php echo e($user->lastAnnonce()->ends_city); ?></p>
                      <p class="text-sm-medium neutral-500"> <?php echo e($user->lastAnnonce()->title); ?> </p>
                    </div>
                    <div class="location-flight"> 
                      <p class="text-sm-medium neutral-500"> <?php echo e($user->lastAnnonce()->created_at->translatedFormat('d M Y')); ?> </p>
                      <p class="neutral-1000"> Kilo Disponible : <span class="text-sm-bold " > <?php echo e($user->lastAnnonce()->kg); ?> kg</span> </p>
                    </div> 
                  </div>
                ...
                <div class="item-info-flight mb-3" >
                  <div class="list-flight-facilities" >
                    <li class="wifi"> 
                      ...
                      </svg> Problème : <?php echo e(0); ?> signalé
                    </li>
                    <li class="duty"> 
                      ...
                      <div class="rate-review ml-2"> 
                        <?php for($i = 0; $i < $user->moyenne(); $i++): ?>
                            <img src="<?php echo e(asset('assets/imgs/page/tour-detail/star-big.svg')); ?>" alt="Travila">                                
                        <?php endfor; ?>
                ...
                <div class="item-info-flight"> 
                  ...
                  <div class="list-flight-facilities"> 
                    <li class="baggage">
                      ...
                      </svg>Total offre : <?php echo e($user->creatorAnnonces()->where('type', 1)->count()); ?>
                    ...
                    <li class="cabin">
                      ...
                      </svg> Total demande :  <?php echo e($user->creatorAnnonces()->where('type', 0)->count()); ?>
                    ...
                    <li class="meal"> 
                      ...
                      </svg>Nomnre de kilo offert : <?php echo e($user->creatorAnnonces()->where('type', 1)->sum('kg')); ?> Kg
                    </li>
                    <li class="priority"> 
                      ...
                      </svg>Nombre de kilo demandé : <?php echo e($user->creatorAnnonces()->where('type', 0)->sum('kg')); ?> Kg
                    </li>
                    <li class="entertainment"> 
                      ...
                      </svg>Nombre de kilo vendu : <?php echo e($user->creatorCommandes()->where('status', 'terminee')->count()); ?> Kg
                    </li>
                    <li class="seating"> 
                      ...
                      </svg>Nombre de kilo acheté : <?php echo e($user->receverCommandes()->where('status', 'terminee')->count()); ?> Kg
                    </li>
            ...
            <div class="box-list-comment background-card"> 
                <div class="list-reviews"> 
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $user->rates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                    <div class="item-review"> 
                        <div class="head-review"> 
                          <div class="author-review"> <img src="<?php echo e(asset('storage/'.$rate->commande?->receverUser?->image)); ?>" alt="Travila">
                            <div class="author-info"> 
                              <p class="text-lg-bold"> <?php echo e($rate->commande?->receverUser?->psuedo); ?> </p>
                              <p class="text-sm-medium neutral-500"> <?php echo e($rate->created_at->translatedFormat('d M Y')); ?> </p>
                            </div>
                          </div>
                        ...
                        <div class="content-review"> 
                          <p class="text-sm-medium neutral-800"> <?php echo e($rate->comment); ?> </p>
                        </div>
                      </div>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217000542/domains/atlasinvest-limited.com/public_html/azilink/resources/views/users/details.blade.php ENDPATH**/ ?>