<?php $__env->startSection('title', config('app.name').' | '.'demandes'); ?>
        ...
        <div class="box-content-main">
          ...
          <div class="content-right">
              ...
              <div class="row align-items-center">
                <div class="col-xl-4 col-md-4 mb-10 text-lg-start text-center">
                  <div class="box-view-type"><a class="display-type display-grid active" href="tour-grid.html"> 
                      ...
                      </svg></a><span class="text-sm-bold neutral-500 number-found">Plus de <?php echo e($toutes_les_demandes); ?> demande(s) disponibles</span></div>
                </div>
              </div>
            </div>
                ...
                <div class="box-list-flights box-list-flights-2"> 
                  ...
                  <div class="item-flight background-card border-1">
                    <div class="flight-route"> 
                      <div class="flight-name"><img src="<?php echo e(asset('assets/imgs/page/tickets/logo' . rand(2, 6) . '.png')); ?>" alt="Travila">
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                   ...
                   <p> Aucune demande trouvée.  <a href="<?php echo e(route('annonces.create',  array_merge(request()->all(), ['type' => 0]) )); ?>" >  Créez en une selon votre recherche.</a> </p>
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination">
                <li class="page-item"><a class="page-link" href="<?php echo e($requests->previousPageUrl()); ?>" aria-label="Previous"><span aria-hidden="true"> 
                ...
                <?php for($i = 1; $i <= $requests->lastPage(); $i++): ?>

                  <?php if($requests->currentPage() === $i): ?>
                  <li class="page-item"><a class="page-link active"><?php echo e($i); ?></a></li>
                  <?php else: ?>
                  <li class="page-item"><a class="page-link" href="<?php echo e($requests->url($i)); ?>"><?php echo e($i); ?></a></li>
                  <?php endif; ?>

                <?php endfor; ?>

                <li class="page-item"><a class="page-link" href="<?php echo e($requests->nextPageUrl()); ?>" aria-label="Next"><span aria-hidden="true"> 
                      <svg width="12" height="12" viewbox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217000542/domains/atlasinvest-limited.com/public_html/azilink/resources/views/annonces/requests/index.blade.php ENDPATH**/ ?>