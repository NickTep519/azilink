...
<?php $__env->startSection('title', config('app.name'). ' | Publiez une request'); ?>
      ...
      <div class="container">       
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">                
            <form action="<?php echo e(route($request->exists ? 'annonces.update' : 'annonces.store', $request)); ?>" method="POST" class="p-5 border rounded-2">
                <?php echo csrf_field(); ?>

                <?php if($request->exists): ?>
                ...
                <div class="row"> 
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="title" name="title" value="<?php echo e(old('title', $request->title)); ?>" class="form-control" placeholder="Titre">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="kg" name="kg" value="<?php echo e(old('kg', $request->kg)); ?>" class="form-control" placeholder="poid en kilogramme">
                    </div>
                    <?php $__errorArgs = ['kg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input  type="text" id="price" name="price" value="<?php echo e(old('price', $request->price)); ?>" class="form-control" placeholder="prix par kilogramme">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="starts_city" name="starts_city" value="<?php echo e(old('starts_city', $request->starts_city)); ?>" class="form-control cityInput" placeholder="Ville de depart">
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="ends_city" name="ends_city" value="<?php echo e(old('ends_city', $request->ends_city)); ?>" class="form-control cityInput" placeholder="Ville d'arrivée">
                      <ul id="suggestions" style="list-style: none; padding: 0; margin-top: 5px;  color :#303c44; background-color: #fff ; border: 1px solid #fff; max-width: 300px;"></ul>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="date" id="starts_at" name="starts_at" value="<?php echo e(old('starts_at',  $request->starts_at->toDateString())); ?>" class="form-control cityInput" placeholder="Date de depart">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="date" id="ends_at" name="ends_at" value="<?php echo e(old('ends_at', $request->ends_at ? $request->ends_at->toDateString() : '')); ?>" class="form-control" placeholder="Date d'arrivée">
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <select name="m_transport" id="m_transport" class="form-select form-control">
                            ...
                            <?php $__currentLoopData = $transports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($request->exists && $request->m_transport == $transport): ?> selected  <?php endif; ?> value="<?php echo e($transport); ?>"><?php echo e($transport); ?></option>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="company" name="company" value="<?php echo e(old('company', $request->company)); ?>" class="form-control" placeholder="compagnie de transport" >
                    </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <textarea name="description" id="description" class="form-control" rows="6" placeholder="Donnez en quelques lignes une expliaction sur votre demande..."> <?php echo e(old('description', $request->description)); ?> </textarea>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="col-lg-12"> 
                    <button class="btn btn-book"> <?php echo e($request->exists ? 'Modifier' : 'Publier'); ?>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projets\taffe\azilink\resources\views\annonces\requests\form.blade.php ENDPATH**/ ?>