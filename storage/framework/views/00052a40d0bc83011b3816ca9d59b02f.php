<?php $__env->startSection('title', config('app.name') . ' | Mes commandes'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="section-box">
                <div class="container">
                        ...
                        <div class="box-heading-left">
                            ...
                            <div class="box-breadcrumb">
                                <div class="breadcrumbs">
                                    <ul>
                                        <li> <a class="icon-home" href="<?php echo e(route('commandes.index')); ?>">Offres</a></li>
                                        <li><a class="icon-home" href="<?php echo e(route('commandes.requests')); ?>">Demandes</a></li>
                        ...
                        <table class="table table-stripped table-mybooking">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $commandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($commande->commande_no); ?>

                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($commande->annonce->title); ?>

                                            </span></td>
                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($commande->kg_commande); ?> kg</span>
                                        </td>
                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($commande->price); ?> €</span></td>
                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($commande->total); ?> €</span></td>
                                        <td> <span class="text-md-medium neutral-500"> <?php echo e($commande->receverUser->name); ?>

                                                <?php echo e($commande->receverUser->first_name); ?> </span>
                                        </td>

                                        <?php if($commande->status == 'creee'): ?>
                                            <td> <span class="btn btn-status"> Créée </span> </td>
                                        <?php endif; ?>
                                        <?php if($commande->status == 'accepte'): ?>
                                            <td> <span class="btn btn-status"> Acceptée </span> </td>
                                        <?php endif; ?>
                                        <?php if($commande->status == 'expediee'): ?>
                                            <td> <span class="btn btn-status"> En Transit </span> </td>
                                        <?php endif; ?>
                                        <?php if($commande->status == 'refuse'): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if($commande->status == 'livree'): ?>
                                            <td> <span class="btn btn-status"> Livrée </span> </td>
                                        <?php endif; ?>
                                        <?php if($commande->status == 'recue'): ?>
                                        ...
                                        <td> <span class="text-md-medium neutral-500">
                                                <?php echo e($commande->updated_at->translatedFormat('j/m/Y')); ?>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end">
                                                    ...
                                                    <?php if($commande->creatorUser->id === auth()->user()->id): ?>
                                                        <?php if($commande->status == 'creee'): ?>
                                                            <li>
                                                                <form action="<?php echo e(route('commandes.update', $commande)); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <?php if($commande->status == 'expediee' || $commande->status == 'livree'): ?>
                                                            <li>
                                                                <form action="<?php echo e(route('commandes.update', $commande)); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item"><a class="page-link" href="<?php echo e($commandes->previousPageUrl()); ?>"
                            ...
                            <?php for($i = 1; $i <= $commandes->lastPage(); $i++): ?>
                                <?php if($commandes->currentPage() === $i): ?>
                                    <li class="page-item"><a class="page-link active"><?php echo e($i); ?></a></li>
                                <?php else: ?>
                                    <li class="page-item"><a class="page-link"
                                            href="<?php echo e($commandes->url($i)); ?>"><?php echo e($i); ?></a></li>
                                <?php endif; ?>
                            <?php endfor; ?>

                            <li class="page-item"><a class="page-link" href="<?php echo e($commandes->nextPageUrl()); ?>"
    ...
    <div id="modal" role="dialog" aria-modal="true" aria-labelledby="add-review-header" class="">
        ...
        <div id="review-form-container">
            ...
            <form action="<?php echo e(route('rates.store')); ?>" method="POST" id="review-form">
                <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('assets/js/rating.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projets\azilink\resources\views/commandes/requests.blade.php ENDPATH**/ ?>