...
@section('title', config('app.name'). ' | Publiez une offer')
      ...
      <div class="container">       
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">                
            <form action="{{route($offer->exists ? 'annonces.update' : 'annonces.store', $offer)}}" method="POST" class="p-5 border rounded-2">
                @csrf
                ...
                <div class="row"> 
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="title" name="title" value="{{old('title', $offer->title)}}" class="form-control" placeholder="Titre">
                    </div>
                    @error('title')
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="kg" name="kg" value="{{old('kg', $offer->kg)}}" class="form-control" placeholder="poid en kilogramme">
                    </div>
                    @error('kg')
                        <div class="alert alert-danger">
                            {{$message}}
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input  type="text" id="price" name="price" value="{{old('price', $offer->price)}}" class="form-control" placeholder="prix par kilogramme">
                    </div>
                    @error('price')
                        <div class="alert alert-danger">
                            {{$message}}
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="starts_city" name="starts_city" value="{{old('starts_city', $offer->starts_city)}}" class="form-control cityInput" placeholder="Ville de depart">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="ends_city" name="ends_city" value="{{old('ends_city', $offer->ends_city)}}" class="form-control cityInput" placeholder="Ville d'arrivée">
                      <ul id="suggestions" style="list-style: none; padding: 0; margin-top: 5px;  color :#303c44; background-color: #fff ; border: 1px solid #fff; max-width: 300px;"></ul>
                    </div>
                    @error('ends_city')
                        <div class="alert alert-danger">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="date" id="starts_at" name="starts_at" value="{{old('starts_at',  $offer->starts_at->toDateString())}}" class="form-control cityInput" placeholder="Date de depart">
                    </div>
                    @error('starts_at')
                        <div class="alert alert-danger">
                            {{$message}}
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="date" id="ends_at" name="ends_at" value="{{old('ends_at', $offer->ends_at ? $offer->ends_at->toDateString() : '')}}" class="form-control" placeholder="Date d'arrivée">
                    </div>
                    @error('ends_at')
                        <div class="alert alert-danger">
                            {{$message}}
                    ...
                    <div class="form-group"> 
                        ...
                        <select name="m_transport" id="m_transport" class="form-select form-control">
                            ...
                            @foreach ($transports as $transport)
                                <option @if ($offer->exists && $offer->m_transport == $transport) selected  @endif value="{{$transport}}">{{$transport}}</option>
                            @endforeach
                        </select>
                    </div>
                    @error('m_transport')
                  ...
                  <div class="col-lg-6">
                    <div class="form-group"> 
                      ...
                      <input type="text" id="company" name="company" value="{{old('company', $offer->company)}}" class="form-control" placeholder="compagnie de transport" >
                    </div>
                    @error('company')
                        <div class="alert alert-danger" >
                            {{$message}}
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <textarea name="description" id="description" class="form-control" rows="6" placeholder="Donnez en quelques lignes une expliaction sur votre offre..."> {{old('description', $offer->description)}} </textarea>
                    </div>
                    @error('description')
                    <div class="alert alert-danger" >
                      {{$message}}
                  ...
                  <div class="col-lg-12"> 
                    <button class="btn btn-book"> {{$offer->exists ? 'Modifier' : 'Publier'}}
