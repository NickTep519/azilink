...
@section('title', config('app.name') . ' | ' . 'offres')
                    ...
                    <form action="">
                        <div class="box-bottom-search background-card">
                            <div class="item-search item-search-2">
                                ...
                                <div>
                                    <input name="starts_city" id="starts_city" value="{{ request()->input('starts_city') }}"
                            ...
                            <div class="item-search item-sea rch-3">
                                ...
                                <div>
                                    <input id="ends_city" name="ends_city" value="{{ request()->input('ends_city') }}"
                                        class="search-input cityInput" type="text" placeholder="">
                                    <ul id="suggestions"
                                        style="list-style: none; padding: 0; margin-top: 5px;  color :#fff; background-color: #303c44 ; border: 1px solid #303c44; max-width: 300px;">
                                    </ul>
                            ...
                            <div class="item-search item-search-2">
                                ...
                                <div>
                                    <input type="number" min="0" id="kg" name="kg" class="search-input"
                                        value="{{ request()->input('kg') }}" placeholder="">
                                    <ul id="suggestions"
                                        style="list-style: none; padding: 0; margin-top: 5px;  color :#fff; background-color: #303c44 ; border: 1px solid #303c44; max-width: 300px;">
                                    </ul>
                                </div>
                            ...
                            <div class="item-search item-search-2">
                                ...
                                <input id="price" class="value-money" value="{{ request()->input('price') }}"
                    ...
                    <div class="content-right">
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-4 col-md-4 mb-10 text-lg-start text-center">
                                    <div class="box-view-type"><a class="display-type display-grid active"
                                            ...
                                            {{ $toutes_les_offres }} offre(s) disponibles </span></div>
                                </div>
                            </div>
                        </div>
                        <div class="box-list-tickets wow fadeIn">
                            <div class="row">
                                            ...
                                            <div class="card-image"> <a class="wish" href="#">
                                                    <svg width="20" height="18" viewbox="0 0 20 18"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round"></path>
                                                    </svg></a><img src="{{ $offer->image_city_destination }}"
                                                    alt="Azilink"></div>
                                            <div class="card-info">
                                                <div class="card-date"><span class="date-1">
                                                        {{ $offer->starts_at->translatedFormat('d M Y') }} </span><span
                                                        class="line"></span><span
                                                        class="date-1">{{ $offer->ends_at->translatedFormat('d M Y') }}</span>
                                                </div>
                                                <div class="card-route">
                                                    <h8 class="route-name neutral-1000"> {{ $offer->starts_city }} </h8>
                                                ...
                                                <div class="card-price">
                                                    <div class="card-price-1">
                                                        ...
                                                        <h6 class="neutral-1000"> {{ $offer->kg_restant }} Kg
                                                        </h6>
                                                    </div>
                                                    <div class="card-price-1">
                                                ...
                                                <div class="card-meta">
                                                    <div class="card-seats" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                                                        ...
                                                        <div class="card-button">
                                                            <a class="btn btn-gray" href="{{ route('offers.show', [$offer->slug(), $offer]) }}">Voir..</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                @empty
                                    ...
                                    <p> Aucune offre trouvée. <a
                                            href="{{ route('annonces.create', array_merge(request()->all(), ['type' => 1])) }}">
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link" href="{{ $offers->previousPageUrl() }}"
                                    ...
                                    @for ($i = 1; $i <= $offers->lastPage(); $i++)
                                        @if ($offers->currentPage() === $i)
                                            <li class="page-item"><a class="page-link active">{{ $i }}</a>
                                            </li>
                                        @else
                                            <li class="page-item"><a class="page-link"
                                                    href="{{ $offers->url($i) }}">{{ $i }}</a></li>
                                        @endif
                                    @endfor

                                    <li class="page-item"><a class="page-link" href="{{ $offers->nextPageUrl() }}"
