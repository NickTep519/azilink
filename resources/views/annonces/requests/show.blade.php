...
@section('meta')
    ...
    <meta property="og:image" content="{{ $request->image_city_destination }}" />
    <meta property="og:type" content="{{ 'website' }}" />
    <meta property="og:site_name" content="{{ config('app.name') }}" />



    <meta name="twitter:card" content="{{ $request->image_city_destination }}">
    <meta name="twitter:title" content="{{ $request->title }}">
    <meta name="twitter:description" content="{{ $request->description }}">
    <meta name="twitter:image" content="{{ $request->image_city_destination }}">
...
@section('title', config('app.name') . ' | requests | ' . $request->title)
        ...
        <section class="box-section box-breadcrumb background-body">
            <div class="container text-center">
                <ul class="breadcrumbs">
                    ...
                    <li> <a href="{{ route('requests.index') }}">requests</a><span class="arrow-right">
                            <svg width="7" height="12" viewbox="0 0 7 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 11L6 6L1 1" stroke="" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                            </svg></span></li>
                    <li> <span class="text-breadcrumb"> {{ $request->title }} </span></li>
                </ul>
            </div>
        </section>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="box-banner-tour-4">
                                        <img src="{{ $request->image_city_destination }}" alt="Travila">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tour-header tour-header-on-top">
                        <div class="box-author-small">
                            ...
                            <p class="text-sm-bold" style="color: white" > 
                                <a href="{{ route('users.details', $request->creatorUser->slug ) }}" style="color: white; text-decoration: none;" class="text-sm-bold">
                                    {{ $request->creatorUser->pseudo }} {{  $request->creatorUser->profileBadge() }}
                                </a>
                            </p>
                        </div>
                        <div class="tour-rate">
                            <div class="rate-element"><span class="rating">  {{ $request->creatorUser->moyenne() }}  <span
                                        class="text-sm-medium neutral-500">( {{ $request->views }} vues)</span></span></div>
                        </div>
                        <div class="tour-title-main w-lg-75">
                            <h4 class="color-white"> {{$request->title}} </h4>
                        </div>
                          ...
                          {{--  <div class="tour-meta-left">
                            ...
                            <div class="tour-meta-right share-container"> <a class="btn btn-share">
                                ...
                                <div class="share-options">
                                    <!-- Liens de partage -->
                                    <a href="https://twitter.com/intent/tweet?text={{ $request->title }}.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!&url={{ urlencode(route('requests.show', [$request->slug(), $request])) }}"
                                        target="_blank">Partager sur Twitter</a>
                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('requests.show', [$request->slug(), $request])) }}"
                                        target="_blank">Partager sur Facebook</a>
                                    <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(route('requests.show', [$request->slug(), $request])) }}&title=Super%20contenu&summary=Ceci%20est%20un%20résumé"
                                        target="_blank">Partager sur LinkedIn</a>
                                    <a href="https://wa.me/?text={{ $request->title }}.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!%20%20%20{{ urlencode(route('requests.show', [$request->slug(), $request])) }}"
                                        target="_blank">Partager sur WhatsApp</a>
                                    <a href="https://t.me/share/url?url={{ urlencode(route('requests.show', [$request->slug(), $request])) }}&text={{ $request->title }}.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!"
                                        target="_blank">Partager sur Telegram</a>
                                    <a href="mailto:?subject={{ $request->title }}.%20Cliquez%20sur%20le%20lien%20pour%20plus%20de%20details%20!{{ urlencode(route('requests.show', [$request->slug(), $request])) }}"
        ...
        <section class="box-section box-content-tour-detail background-body">
            <div class="container">
                <div class="row">
                        ...
                        <div class="box-info-tour">
                            ...
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> {{ $request->starts_city }} </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                <div class="icon-item">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> {{ $request->starts_at->translatedFormat('d M Y') }} </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> {{ $request->ends_city  }} </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> {{ $request->ends_at->translatedFormat('d M Y') }} </p>
                                </div>
                            </div>
                        </div>
                        <div class="box-info-tour">
                            ...
                            <div class="tour-info-group">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> {{ $request->company }} </p>
                                </div>
                            </div>
                            <div class="tour-info-group">
                                <div class="icon-item background-3">
                                ...
                                <div class="info-item">
                                    ...
                                    <p class="text-lg-bold neutral-1000"> {{ $request->m_transport }} </p>
                                </div>
                            </div>
                        </div>
                    ...
                    @if (auth()->check())
                        @if (auth()->user()->id === $request->creatorUser->id)
                        @else
                            <div class="col-lg-4">
                                    ...
                                    <div class="content-booking-form">
                                        <form action="{{ route('conversations.store') }}" method="POST">
                                            ...
                                            <input type="hidden" name="user_ids[]"
                                                value="{{ $request->creatorUser->id }}">
                                            <input type="hidden" name="user_ids[]" value="{{ auth()->user()->id }}">
                                            <input type="hidden" name="annonce_id" value="{{ $request->id }}">
