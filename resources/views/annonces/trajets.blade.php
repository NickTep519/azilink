                ...
                <div class="container">
                    ...
                    <div class="section-box box-statistical">
                        <div class="row">
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="{{ asset('dash/assets/imgs/template/icons/hotel2.svg') }}"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span
                                                    class="count">{{ $trajets_en_cours->count() }}</span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="{{ asset('dash/assets/imgs/template/icons/user.svg') }}"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span class="count">
                                                    {{ $trajets_termine->count() }} </span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="{{ asset('dash/assets/imgs/template/icons/book.svg') }}"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span class="count">
                                                    {{ $trajets_termine->count() + $trajets_en_cours->count() }} </span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    <div class="card-image"> <span><img
                                                src="{{ asset('dash/assets/imgs/template/icons/earn.svg') }}"
                                                alt="Azilink"></span></div>
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span class="count">
                                                    {{ $gain_en_cours->count() }} </span>
                                            </h3>
                                        </div>
                            ...
                            <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                <div class="card-style-1 hover-up">
                                    ...
                                    <div class="card-info">
                                        <div class="card-title">
                                            <h3 class="text-xl-bold neutral-1000"><span
                                                    class="count">{{ $gain_en_cours->count() + $gain_termine->count() }}</span>
                                            </h3>
                                        </div>
                                ...
                                @forelse ($trajets as $trajet)
                                    <tr>
                                        <td alt="titre"> <span class="text-md-medium neutral-500">
                                                {{ $trajet->type == 1 ? 'Offre' : 'Demande' }} </span>
                                            @if ($trajet->status === 'archive')
                                                🗃️
                                            @endif
                                        </td>
                                        <td> <span class="text-md-medium neutral-500"> {{ $trajet->starts_city }} </span>
                                        </td>
                                        <td> <span class="text-md-medium neutral-500"> {{ $trajet->ends_city }} </span>
                                        </td>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end">
                                                    @if ($trajet->type == 1)
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('offers.show', [$trajet->slug(), $trajet]) }}">Voir</a>
                                                        </li>
                                                    @else
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('requests.show', [$trajet->slug(), $trajet]) }}">Voir</a>
                                                        </li>
                                                    @endif


                                                    <li><a class="dropdown-item"
                                                            href="{{ route('annonces.edit', $trajet) }}">Editer</a></li>
                                                    @if ($trajet->status != 'archive')
                                                        <li>
                                                            <form action="{{ route('annonces.archive', $trajet) }}"
                                                                method="POST">
                                                                @csrf
                                                    ...
                                                    <li>
                                                        <form action="{{ route('annonces.destroy', $trajet) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                    ...
                    @if (!$trajets->isEmpty() && $trajets->count() >= 30)
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="{{ $trajets->previousPageUrl() }}"
                                ...
                                @for ($i = 1; $i <= $trajets->lastPage(); $i++)
                                    ...
                                    @else
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $trajets->url($i) }}">{{ $i }}</a></li>
                                    @endif
                                @endfor

                                <li class="page-item"><a class="page-link" href="{{ $trajets->nextPageUrl() }}"
