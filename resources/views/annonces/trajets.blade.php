...
@section('title', config('app.name'). ' | Mes Trajets')
          ...
          <div class="container"> 
            <div class="box-heading">
              ...
              <div class="box-heading-right"> 
                    <a class="btn btn-brand-secondary" href="{{route('annonces.create')}}"> 
              ...
              <div class="row"> 
                <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6"> 
                  <div class="card-style-1 hover-up">
                    <div class="card-image"> <span><img src="{{asset('dash/assets/imgs/template/icons/hotel2.svg')}}" alt="Azilink"></span></div>
                    <div class="card-info"> 
                      <div class="card-title">
                        <h3 class="text-xl-bold neutral-1000"><span class="count">{{$trajets_en_cours->count()}}</span>
                        </h3>
                      </div>
                ...
                <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image"> <span><img src="{{asset('dash/assets/imgs/template/icons/user.svg')}}" alt="Azilink"></span></div>
                    <div class="card-info"> 
                      <div class="card-title">
                        <h3 class="text-xl-bold neutral-1000"><span class="count">  {{$trajets_termine->count()}} </span>
                        </h3>
                      </div>
                ...
                <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image"> <span><img src="{{asset('dash/assets/imgs/template/icons/book.svg')}}" alt="Azilink"></span></div>
                    <div class="card-info"> 
                      <div class="card-title">
                        <h3 class="text-xl-bold neutral-1000"><span class="count"> {{$trajets_termine->count() + $trajets_en_cours->count()}} </span>
                        </h3>
                      </div>
                ...
                <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image"> <span><img src="{{asset('dash/assets/imgs/template/icons/earn.svg')}}" alt="Azilink"></span></div>
                    <div class="card-info"> 
                      <div class="card-title">
                        <h3 class="text-xl-bold neutral-1000"><span class="count"> {{$gain_en_cours->count()}} </span>
                        </h3>
                      </div>
                ...
                <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    ...
                    <div class="card-info"> 
                      <div class="card-title">
                        <h3 class="text-xl-bold neutral-1000"><span class="count"> {{$gain_termine->count()}} </span>
                        </h3>
                      </div>
                ...
                <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    ...
                    <div class="card-info"> 
                      <div class="card-title">
                        <h3 class="text-xl-bold neutral-1000"><span class="count">{{$gain_en_cours->count() + $gain_termine->count() }}</span>
                        </h3>
                      </div>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-stripped table-mybooking">
                    ...
                    <tr> 
                            <td alt="titre" > <span class="text-md-medium neutral-500"> {{$trajet->type==1 ? 'Offre' : 'Demande' }} </span></td>
                            <td> <span class="text-md-medium neutral-500"> {{ $trajet->starts_city }} </span></td>
                            <td> <span class="text-md-medium neutral-500"> {{$trajet->ends_city}} </span></td>
                            <td> <span class="text-md-medium neutral-500"> {{$trajet->kg}} kg </span></td>
                            <td> <span class="text-md-medium neutral-500"> {{$trajet->price}} €</span></td>
                            @if ($trajet->status == 'en_attente')
                        ...
                        <td class="text-center"> 
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light dropdown-menu-end">
                                    @if ($trajet->type == 1)
                                    <li><a class="dropdown-item" href="{{route('offers.show', [$trajet->slug(), $trajet] )}}">Voir</a></li>
                                    @else
                                    <li><a class="dropdown-item" href="{{route('requests.show', [$trajet->slug(), $trajet] )}}">Voir</a></li>
                                    @endif
    
                                   
                                    <li><a class="dropdown-item" href="{{route('annonces.edit', $trajet)}}">Editer</a></li>
                                    <li>
                                         <form action="{{route('annonces.archive', $trajet)}}" method="POST" >
                                            @csrf
                                    ...
                                    <li>
                                         <form action="{{route('annonces.destroy', $trajet)}}" method="POST" >
                                            @csrf
                                            @method('delete')
            ...
            @if (!$trajets->isEmpty() && $trajets->count()>= 30)
            <nav aria-label="Page navigation example">
              <ul class="pagination">
                <li class="page-item"><a class="page-link" href="{{$trajets->previousPageUrl()}}" aria-label="Previous"><span aria-hidden="true"> 
                ...
                @for ($i = 1; $i <= $trajets->lastPage(); $i++)

                  @if ($trajets->currentPage() === $i)
                  <li class="page-item"><a class="page-link active">{{ $i }}</a></li>
                  @else
                  <li class="page-item"><a class="page-link" href="{{$trajets->url($i)}}">{{ $i }}</a></li>
                  @endif

                @endfor

                <li class="page-item"><a class="page-link" href="{{$trajets->nextPageUrl()}}" aria-label="Next"><span aria-hidden="true"> 
                      <svg width="12" height="12" viewbox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
