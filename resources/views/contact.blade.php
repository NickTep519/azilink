          ...
          <div class="row mt-60"> 
            <div class="col-lg-4 col-sm-6">
              <div class="card-contact"> 
                ...
                <div class="card-info"> 
                  <div class="card-title"> <a class="title text-lg-bold" href="{{route('faq')}}">Aide &amp; FAQs</a>
                ...
                <div class="row"> 
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <input class="form-control username" type="text" placeholder="Prénom(s)" name="firstname" value="{{old('firstname')}}">
                      @error('firstname')
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <input class="form-control username" type="text" placeholder="Nom" value="{{old('name')}}"  name="name">
                      @error('name')
                        <div class="alert alert-danger" > {{$message}} </div>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <input class="form-control email" type="email" placeholder="email@domain.com" value="{{old('email')}}"  name="email">
                      @error('email')
                        <div class="alert alert-danger" > {{$message}} </div>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <input class="form-control phone" type="text" placeholder="Téléphone" value="{{old('phone')}}" name="phone">
                      @error('phone')
                        <div class="alert alert-danger" > {{$message}} </div>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group"> 
                      ...
                      <textarea class="form-control" rows="6" placeholder="Laissez-nous un message..."  name="message">{{old('message')}}</textarea>
                      @error('message')
                        <div class="alert alert-danger" > {{$message}} </div>
                      @enderror
                    </div>
              ...
              <div class="banner-contact"> 
                <div class="row"> 
                  ...
                  <div class="col-sm-6">
                    ...
                    {{-- <div class="banner-img-contact"> <img class="bdrd-16" src="assets/imgs/page/pages/banner-contact3.png" alt="Travilla"></div> --}}
                  </div>
                  {{-- <div class="col-sm-6">
                    <div class="banner-img-contact"> <img class="bdrd-16" src="assets/imgs/page/pages/banner-contact2.png" alt="Travilla"></div>
                    <div class="banner-img-contact"> <img class="bdrd-16" src="assets/imgs/page/pages/banner-contact4.png" alt="Travilla"></div>
                  </div> --}}
                </div>
              </div>
            </div>
