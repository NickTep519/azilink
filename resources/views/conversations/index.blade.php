                                            ...
                                            <li> 
                                                <a href="#" id="loadConversation"
                                                    ...
                                                    class="flip"> 
                                                        ...
                                                        <span> 
                                                            {{ $conversation->users->where('id', '!=', auth()->user()->id)->first()->name }} | {{ Str::limit($conversation->title, 15)  }}
                                                        </span> 
												...
												@csrf
													...
													<div class="modal-body">
														...
														<div class="form-group">
															<input type="text" id="kg_commande" name="kg_commande"  value="{{ old('kg_commande') }}" required  class="form-control" placeholder="Nombre de Kilo">
															<x-input-error :messages="$errors->get('kg_commande')" class="mt-2" />
														</div>

														<div class="form-group">
															<input type="text" id="price" name="price"  value="{{ old('price') }}" class="form-control" placeholder="Prix/kg">
