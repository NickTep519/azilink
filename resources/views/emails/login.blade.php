                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;"> {{ config('app.name') }}
                                        </h1>
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            Examinez une connexion récente effectuée depuis un nouvel appareil. <br/> Quelqu'un s'est récement connecté à votre compte {{config('app.name')}} <br><strong>Please change
                                        ...
                                        <p
                                            ...
                                            <strong
                                                style="display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">Username</strong> {{ $credentials['email'] }}
                                            {{-- <strong
                                        ...
                                        <a href="{{route('home')}}"
                                            style="background:#3c0add;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;"> {{config('app.name')}} 
                                        </a>
